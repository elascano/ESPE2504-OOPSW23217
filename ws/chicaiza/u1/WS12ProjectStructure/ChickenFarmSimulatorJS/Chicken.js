class Chicken {
  ...
  toString() {
    return `Chicken{id=${this.id}, name=${this.name}, color=${this.color}, age=${this.age}, molting=${this.molting}, bornOnDate=${this.bornOnDate.toDateString()}}`;
  }
  ...
  cluck() {
    ...
    console.log(`chicken date --> ${this.bornOnDate.toDateString()}`);
