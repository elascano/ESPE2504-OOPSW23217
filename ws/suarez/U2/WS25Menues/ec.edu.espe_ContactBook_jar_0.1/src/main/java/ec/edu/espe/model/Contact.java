...
public class Contact {
    ...
    public String email;
    public boolean frequentFriend;
    public String type; //family, friend, job, university
    public Calendar bornOnType;
    public String comments;
    public ArrayList<Sport> sports;
    
    public void chat(Contact contact){
        System.out.println(" chatting with contact --> " + contact.getFirstName());
    }
