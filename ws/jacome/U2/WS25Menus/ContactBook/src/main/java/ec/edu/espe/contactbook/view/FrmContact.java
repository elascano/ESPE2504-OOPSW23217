...
public class FrmContact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstSport = new javax.swing.JList<>();
        ...
        lstSport.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Soccer", "Football", "Basketball", "Baseball", "Tennis", "Swimming", "Volley" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(lstSport);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, lstSport.getSelectedValues());
    ...
    private javax.swing.JList<String> lstSport;
