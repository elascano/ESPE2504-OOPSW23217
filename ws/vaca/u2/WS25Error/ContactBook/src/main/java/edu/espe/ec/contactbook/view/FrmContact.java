...
import edu.espe.ec.contactbook.model.Contact;
import edu.espe.ec.contactbook.model.Sport;
...
public class FrmContact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtId.setToolTipText("Just type numbers (Ex: 1001)");
        ...
        txtCellphoneNumber.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtCellphoneNumberFocusLost(evt);
            }
        });
        ...
        txtCellphoneNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtCellphoneNumberKeyTyped(evt);
            }
        });
    ...
    private void btmSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmSaveActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Please enter a number","Error on Cellphone",JOptionPane.ERROR_MESSAGE);
    ...
    private void txtCellphoneNumberFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCellphoneNumberFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCellphoneNumberFocusLost

    private void txtCellphoneNumberKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCellphoneNumberKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCellphoneNumberKeyTyped
