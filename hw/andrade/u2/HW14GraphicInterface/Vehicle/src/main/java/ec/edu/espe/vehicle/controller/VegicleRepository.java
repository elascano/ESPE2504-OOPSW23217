 ...
 * @author PC
 */
public class VegicleRepository {
    public Vehicle createVehicle(String brand, String model, boolean isDigital, int numChannels, float price, String serialNumber) {
        ...
        Vehicle soundMixer = new Vehicle(brand, model, isDigital, numChannels, price, serialNumber);
    ...
    public boolean saveIfNotExists(Vehicle soundMixer) {
